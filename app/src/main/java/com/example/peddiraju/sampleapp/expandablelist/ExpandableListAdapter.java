package com.example.peddiraju.sampleapp.expandablelist;
...
import com.example.peddiraju.sampleapp.items.*;
...
public class ExpandableListAdapter extends RecyclerView.Adapter<Holder> {
    ...
    public void onBindViewHolder(Holder holder, int position) {
        ...
        if (!(item instanceof Item)) {
            int end = item.isExpanded() ? R.mipmap.plus_icon :  R.mipmap.plus_icon;
